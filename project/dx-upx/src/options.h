...
struct options_t {
    ...
    struct {
        ...
        unsigned int android_debug_sighash; //android apk signature hashcode for internal debug only, do not expose this!!!
        unsigned int android_signhash;// android apk signature hashcode
        unsigned int expire_time;
        bool anti_ida;  //pop-up dialogs in ida pro
        bool android_check_integrity;
        bool fix_sdk_build;
        bool android_anti_dump;
        bool encrypt_shellcode;
        bool android_anti_debug;
        bool expand_space;
    } o_unix;
    struct {
        bool le;
