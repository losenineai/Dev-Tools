...
public class DeviceBandwidthSampler {
   ...
   */
  private final NetworkQualityManager mConnectionClassManager;
  ...
  private static class DeviceBandwidthSamplerHolder {
      public static final DeviceBandwidthSampler instance =
              new DeviceBandwidthSampler(NetworkQualityManager.getInstance());
  }
  ...
  private DeviceBandwidthSampler(
      NetworkQualityManager connectionClassManager) {
