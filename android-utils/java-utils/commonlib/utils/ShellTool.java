...
public class ShellTool {
	...
	public static CommandResult execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg) {
        ...
        try {
            RootShellProcess commonProcess = null;
            if (isRoot) {
                ...
                commonProcess = mRootProcess;
            }
            else{
                commonProcess = new RootShellProcess(false);
            }
...
//			cmdBuilder.append("echo $?");
            ...
            LogTool.d(TAG, "execCommand : " + cmdBuilder );
			String resultStr = commonProcess.exec(cmdBuilder.toString());
			LogTool.d(TAG, cmdBuilder + " resultStr " + resultStr);
		...
		LogTool.d(TAG, "result:" + result + ", successMsg: " + (successMsg == null ? "null" : successMsg.toString())
...
//				LogTool.d(TAG, "new RootShellProcess() 2 resultStr ：" + resultStr + " cur id " + Thread.currentThread().getId());
...
//				mRootProcess = null;
//			}
			LogTool.d(TAG, "new RootShellProcess() 3, result is " + result + " cur id " + Thread.currentThread().getId());
	...
	public static class RootShellProcess {
        ...
        public RootShellProcess(boolean isRoot){
            try {
