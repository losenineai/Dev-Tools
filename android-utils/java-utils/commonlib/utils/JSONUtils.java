...
public class JSONUtils {
    ...
    public static <T> T parseJsonToObj(String jsonData, TypeToken<T> c){
        if (null == jsonData)
            return null;
        ...
        T obj = null;
        try {
            obj = gson.fromJson(jsonData.trim(), c.getType());
        } catch (Exception e) {
...
//        LogTool.d(TAG, "parseObjToString" + str);
        return str;
    }

    public static String parseObjToString(Object obj, TypeToken<?> c) {
        String str = "";
        if (obj == null) {
            return str;
        }
