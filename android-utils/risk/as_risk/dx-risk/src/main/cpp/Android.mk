...
include $(CLEAR_VARS)
LOCAL_MODULE    := DXLibc
LOCAL_SRC_FILES := $(LOCAL_PATH)/android/dx-libs/dx-libc/libs/$(TARGET_ARCH_ABI)/libDxLibc.a
include $(PREBUILT_STATIC_LIBRARY)
# DXLibc end
...
include $(CLEAR_VARS)
LOCAL_MODULE    := LibJdi
LOCAL_SRC_FILES := $(LOCAL_PATH)/android/dx-libs/libjdi/$(TARGET_ARCH_ABI)/libjdi.a
include $(PREBUILT_STATIC_LIBRARY)
# LibJdi end
# ************************** DXRisk Version **************************
include $(CLEAR_VARS)
...
LOCAL_C_INCLUDES +=                                     \
    ...
    $(LOCAL_PATH)/android/dx-libs/dx-libc               \
    $(LOCAL_PATH)/android/dx-libs/libjdi                \
    $(UUID_INCLUDE)                                     \

# PBLite begin
PBLITE_SRC :=     $(wildcard $(LOCAL_PATH)/core/src/protobuf-c/*.c)
...
LOCAL_SRC_FILES :=  $(PBLITE_SRC:$(LOCAL_PATH)/%=%)         \
...
LOCAL_STATIC_LIBRARIES += DXAnti DXHook DXLibc LibJdi
